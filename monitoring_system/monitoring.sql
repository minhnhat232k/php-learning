...
CREATE TABLE `borrowed_tools` (
  ...
  `borrowed_date` nvarchar(30) NOT NULL,
  `borrowed_time` nvarchar(30) NOT NULL,
  `due_date` nvarchar(30) NOT NULL,
  `date_returned` nvarchar(30) NOT NULL,
...
CREATE TABLE `equip_mapping` (
  ...
  `location_id` int(11) NOT NULL,
  `date_borrowed` nvarchar(30) NOT NULL,
  `time_borrowed` nvarchar(30) NOT NULL,
  `due_date` nvarchar(30) NOT NULL,
  `date_returned` nvarchar(30) NOT NULL,
  `status` nvarchar(30) NOT NULL,
  `emp_id` int(11) NOT NULL
...
(1, 'user Admin was login', '2022-04-15 16:50:23'),
(2, 'user Admin was logout', '2022-04-15 16:50:46'),
(3, 'user Admin was login', '2022-04-15 16:51:55'),
(4, 'employee judayy was Added', '2022-04-15 16:58:00'),
(5, 'employee juday was updated', '2022-04-15 16:59:02'),
(6, 'employee juday was updated', '2022-04-15 16:59:02'),
(7, 'employee juday was updated', '2022-04-16 16:59:02'),
(8, 'employee juday was updated', '2022-04-16 16:59:02'),
(9, 'employee juday was updated', '2022-04-16 17:00:30'),
(10, 'employee juday was updated', '2022-04-16 17:00:30'),
(11, 'employee juday was updated', '2022-04-30 17:00:30'),
(12, 'employee juday was updated', '2022-04-30 17:00:30'),
(13, 'user Admin was logout', '2022-04-30 17:01:05'),
(14, 'user Admin was login', '2022-04-30 17:01:13'),
(15, 'location Bagoo City\r\n was updated', '2022-04-30 17:02:00'),
(16, 'location Bagoo City\r\n was updated', '2022-04-30 17:02:00'),
(17, 'location Bagoo City\r\n was updated', '2022-04-30 17:02:00'),
(18, 'location Bagoo City\r\n was updated', '2022-04-30 17:02:00'),
(19, 'location Bagoo City\r\n was updated', '2022-04-30 17:02:00'),
(20, 'location Bagoo City\r\n was updated', '2022-04-30 17:02:00'),
(21, 'user Admin was logout', '2022-04-30 17:06:43'),
(22, 'user Admin was login', '2022-04-30 17:06:49'),
(23, 'user Admin was login', '2022-04-30 00:49:05'),
(24, 'user Admin was logout', '2022-04-30 00:49:19'),
(25, 'user Admin was login', '2022-05-01 00:49:24'),
(26, 'employee Adrian Mercurio was Added', '2022-05-01 00:49:56'),
(27, 'user Admin was logout', '2022-05-01 00:50:22'),
(28, 'user Admin was login', '2022-05-01 00:53:20'),
(29, 'user Admin was login', '2022-05-01 02:52:31'),
(30, 'user Admin was login', '2022-05-01 14:22:29'),
(31, 'user Admin was login', '2022-05-04 06:44:16'),
(32, 'user John Smith was logout', '2022-05-04 08:10:21'),
(33, 'user Admin was login', '2022-05-04 08:10:27'),
(34, 'user Admin was login', '2022-05-04 11:49:08'),
(35, 'equipment tracktor was Added', '2022-05-04 11:51:48'),
(36, 'user Admin was login', '2022-05-04 12:40:59'),
(37, 'transfered equipment id 6 from 1 to 6 by employee 1', '2022-05-04 12:45:14'),
(38, 'user Admin was login', '2022-05-04 14:28:48'),
(39, 'returned equipment id 7', '2022-05-04 14:33:27'),
(40, 'returned tool id 1', '2022-05-04 14:53:24'),
(41, 'location Bago City\r\n was updated', '2022-05-04 15:13:32'),
(42, 'location Bago City\r\n was updated', '2022-05-04 15:13:32'),
(43, 'location Bago City\r\n was updated', '2022-05-04 15:13:32'),
(44, 'location Bago City\r\n was updated', '2022-05-04 15:13:32'),
(45, 'location Bago City\r\n was updated', '2022-05-04 15:13:32'),
(46, 'location Bago City\r\n was updated', '2022-05-04 15:13:32'),
(47, 'user Admin was login', '2022-05-04 04:40:32');
...
CREATE TABLE `outsourcing` (
  ...
  `equip_id` int(11) NOT NULL,
  `qty` int(11) NOT NULL,
  `date_outsourced` nvarchar(30) NOT NULL,
...
CREATE TABLE `temp` (
  ...
  `emp_id` int(11) NOT NULL,
  `location_id` int(11) NOT NULL,
  `unique_id` nvarchar(30) NOT NULL,
  `status` nvarchar(30) NOT NULL,
  `company_name` nvarchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `transfered_equipment` (
  ...
  `date_transfered` nvarchar(30) NOT NULL,
  `time_transfered` nvarchar(30) NOT NULL,
...
(14, 66, 6, 1, 4, '2022-05-04', '20:45:14 PM', 1, 6, '', 'TRANSFERED');
